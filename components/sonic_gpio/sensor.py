...
ultrasonic_ns = cg.esphome_ns.namespace("sonic_gpio")
SonicGPIOComponent = ultrasonic_ns.class_(
    "SonicGPIOComponent", sensor.Sensor, cg.PollingComponent
)
    ...
    .extend(
        {
            ...
            cv.Optional(CONF_TIMEOUT, default="4.5m"): cv.distance,
            cv.Optional(
